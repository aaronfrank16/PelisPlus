...
public class PeliculasJpaController implements Serializable {
    ...
    public Peliculas findPeliculasByProduct(Productos id) {
        List<Peliculas> pelicula = null;
        EntityManager em = getEntityManager();
        System.out.println("Buscado pelicula po idProducto "+id);
        Query consulta = em.createNamedQuery("Peliculas.findByIdProducto");
